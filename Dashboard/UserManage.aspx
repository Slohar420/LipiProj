<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard/DSMaster.master" AutoEventWireup="true" CodeFile="UserManage.aspx.cs" Inherits="Dashboard_Dashboard" %>
                    ...
                    <div class="row">
                        <div class="card" style="width: 50%; margin: 20px; margin-left: 60px">
                            ...
                            <div class="card-body">
                                ...
                                <asp:TextBox ID="txtFirstName" class="form-control " placeholder="Enter First Name" runat="server" MaxLength="30" onkeypress="return RestrictSpace()" AutoCompleteType="Disabled" autocomplete="off"></asp:TextBox>

                                <label for="psw-repeat"><b>Last Name</b></label>
                                <asp:TextBox ID="txtLastName" class="form-control " placeholder="Enter Last Name" runat="server" MaxLength="30" onkeypress="return RestrictSpace()" AutoCompleteType="Disabled" autocomplete="off"></asp:TextBox>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="col-lg-11 col-sm-11 col-md-11 col-xs-11">
                                <h3 style="color:#A09A9A">User Details</h3>                            
                            </div>              
                        ...
                        <div class="card-body" style="max-height: 700px; overflow-y: auto;">
                            <asp:GridView ID="GV_UserList" runat="server" EnableEventValidation="true" font-size= "Large" OnRowCommand="GV_UserList_RowCommand"  OnRowDataBound="GV_UserList_RowDataBound" CellPadding="4" ForeColor="Black" AutoGenerateColumns="False" GridLines="Vertical" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Reset Password"  ItemStyle-Width="200">
                                        <ItemTemplate>
                                            <asp:Button Text="Reset" BackColor="#337ab7" ID="btnEditPassword" Visible="true" class="btn btn-primary" CommandArgument="<%# Container.DataItemIndex %>" runat="server" CommandName="EditPassword" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Delete"  ItemStyle-Width="200">
                                        <ItemTemplate>
                                            <asp:Button Text="Delete" ID="btnDeleteUser" Visible="true"  class="btn btn-danger" CommandArgument="<%# Container.DataItemIndex %>" runat="server" CommandName="Delete_User" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="pk_UserId" HeaderText="Emp_id" HeaderStyle-CssClass="hide" ItemStyle-CssClass="hide"></asp:BoundField>
